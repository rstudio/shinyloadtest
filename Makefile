...
.PHONY=clean urls site readme demo_data devinstall build_site prep_vignettes document rcmdcheck
...
help:
	...
	@echo "make demo_data: builds all data from data-raw"
	...
	@echo "make document: builds the pkg documentation"
