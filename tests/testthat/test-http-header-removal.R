...
test_that("hop-by-hop headers removed from Rook requests", {
  rook_req <-
    list(
      ...
      QUERY_STRING = "",
      httpuv.version = structure(list(c(1L, 4L, 5L, 9000L)), class = c("package_version",
                                                                       "numeric_version")),
...
test_that("hop-by-hop headers removed from httr responses", {
  httr_resp <-
    list(
      ...
      content = as.raw(
        c(0x7b, 0x22, 0x77, 0x65, 0x62, 0x73, 0x6f, 0x63, 0x6b, 0x65, 0x74, 0x22, 0x3a, 0x74, 0x72, 0x75, 0x65, 0x2c, 0x22, 0x6f, 0x72, 0x69, 0x67, 0x69, 0x6e, 0x73, 0x22,
