...
> This is a WIP, do not use yet. Please follow [community.rstudio.com](https://community.rstudio.com) for a
...
![Analysis Example](./docs/articles/images/slt_report_screenshot.png)
...
```r
shinyloadtest::make_report(df, "run1.html")
```
