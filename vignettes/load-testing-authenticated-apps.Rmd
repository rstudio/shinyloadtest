...
`shinyloadtest` supports load testing applications served by [RStudio Connect](https://www.rstudio.com/products/connect/) or [Shiny Server Pro](https://www.rstudio.com/products/connect/) with the following authentication schemes:
