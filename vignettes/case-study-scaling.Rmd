...
> If you don't want to generate the report yourself, you can view an example here: [case_study_report1.html](case_study_report1.html)
...
> If you don't want to generate the report yourself, you can view an example here: [case_study_report2.html](case_study_report2.html)

![run2-duration](../docs/inst/img/run2_duration.svg)
![run2-duration](../docs/inst/img/run2_new_duration.svg)
