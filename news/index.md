...
- Fixed R CMD check NOTE about undefined global variable `id` in `dplyr`
  code ([\#182](https://github.com/rstudio/shinyloadtest/issues/182)).

- Waterfall plot labels now support all message types as of `shiny`
  v1.9.1, removing empty `Set:` and `Updated:` labels and replacing them
  with appropriate labels
  ([\#179](https://github.com/rstudio/shinyloadtest/issues/179)).
