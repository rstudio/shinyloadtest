...
# source("scripts/test_sessions.R", echo = TRUE, local = TRUE)
...
load_runs(
  ...
  shinyloadtest_report(
    "vignettes/case_studies/case_study_report1.html",
    self_contained = TRUE,
    open_browser = open_browser
  )
...
load_runs(
  ...
  shinyloadtest_report(
    "vignettes/case_studies/case_study_report2.html",
    self_contained = TRUE,
    open_browser = open_browser
  )
